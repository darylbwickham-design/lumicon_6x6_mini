...
// ============================================================================
// These are deliberately declared before any function that references `pet`.
// This avoids the classic compile issue:
//   'pet' was not declared in this scope
// ============================================================================
...
void drawFooter() {
  const String text = "Lumia /pet control";
