...
// so we encode colors in the panel's expected byte order here.
...
// Panel-corrected RGB565 helper.
// Leave the name as rgb565 so the existing drawing code keeps working.
