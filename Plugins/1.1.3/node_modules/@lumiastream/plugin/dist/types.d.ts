...
export type PluginNamedMapValueType = "text" | "datetime" | "number" | "select" | "checkbox" | "switch" | "toggle" | "file" | "json";
...
export interface PluginNamedMapValueFieldConfig {
    type?: "text" | "datetime" | "number" | "select" | "checkbox" | "switch" | "slider" | "file" | "password" | "toggle" | "textarea" | "email" | "url" | "color" | "json" | "roi";
    placeholder?: string;
    helperText?: string;
    required?: boolean;
...
export interface PluginSetting {
    key: string;
    label: string;
    type: "text" | "datetime" | "number" | "select" | "checkbox" | "slider" | "file" | "password" | "toggle" | "textarea" | "email" | "url" | "color" | "json" | "roi" | PluginNamedMapFieldType;
    placeholder?: string;
    helperText?: string;
    required?: boolean;
    options?: Array<{
    ...
    defaultValue?: string | number | boolean | string[] | Record<string, unknown> | Array<unknown>;
    disabled?: boolean;
    hidden?: boolean;
...
export interface PluginVisibleIfCondition {
    key: string;
    equals: string | number | boolean | null | Array<string | number | boolean | null>;
}
...
export interface PluginActionField {
    key: string;
    label: string;
    type: "text" | "datetime" | "number" | "select" | "checkbox" | "switch" | "slider" | "file" | "email" | "url" | "password" | "textarea" | "color";
    placeholder?: string;
    helperText?: string;
    required?: boolean;
...
export type PluginActionPayloadValue = Record<string, unknown> | string | number | boolean | Array<unknown> | null;
...
export type PluginModCommandOption = "delete" | "copy" | "translate" | "shoutout" | "ban" | "unban" | "timeout" | "add-vip" | "remove-vip" | "add-moderator" | "remove-moderator";
...
export interface ILumiaAPI {
     ...
     */
    acquireShared: <T = any>(key: string, factory?: () => T | Promise<T>, options?: PluginSharedResourceOptions<T>) => Promise<T>;
    /**
    ...
    } | string | number, type?: "info" | "warn" | "warning" | "error" | "success" | "debug") => Promise<boolean>;
    dashboardLog: (params: {
        message?: unknown;
        level?: "info" | "warn" | "warning" | "error" | "success" | "debug";
        type?: "info" | "warn" | "warning" | "error" | "success" | "debug";
...
export interface PluginRuntime {
    ...
    aiModels?(config?: PluginAIModelsRequestOptions): Promise<Array<PluginAIModelOption | string> | {
        models?: Array<PluginAIModelOption | string>;
    } | void> | Array<PluginAIModelOption | string> | {
        models?: Array<PluginAIModelOption | string>;
    } | void;
    ...
    variableFunction?(config: PluginVariableFunctionContext): Promise<string | PluginVariableFunctionResult | undefined>;
    ...
    settings: Record<string, any>;
    onsettingsupdate?(settings: Record<string, any>, previousSettings: Record<string, any>): Promise<void> | void;
}
/**
...
export interface PluginFormField {
    key: string;
    label: string;
    type: "text" | "datetime" | "password" | "number" | "email" | "url" | "textarea" | "select" | "checkbox" | "toggle" | "color" | "slider" | "file" | "json" | "roi" | PluginNamedMapFieldType;
    placeholder?: string;
    helperText?: string;
    required?: boolean;
    defaultValue?: any;
...
export type PluginAuthValidationResponse = boolean | PluginAuthValidationResult | string;
